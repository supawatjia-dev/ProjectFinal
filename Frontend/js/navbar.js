function renderNavbar(activePage) {
  ...
  nav.innerHTML = `
    ...
    <ul class="navbar-nav">
      ...
      <li><a href="profile.html" class="${activePage === 'profile' ? 'active' : ''}">👤 ${user?.firstname || 'โปรไฟล์'}</a></li>
      ${isTeacher ? `<li><a href="management.html" class="${activePage === 'management' ? 'active' : ''}">⚙️ จัดการ</a></li>` : ''}
